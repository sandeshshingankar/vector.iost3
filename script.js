...
document.querySelectorAll('.feature-card, .app-card, .pricing-card, .step-item').forEach(el => {
...
// ==================== CARD MAGNETIC TILT ====================
document.querySelectorAll('.feature-card, .app-card, .pricing-card').forEach(card => {
